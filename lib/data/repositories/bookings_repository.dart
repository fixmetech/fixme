...
class BookingsRepository {
  ...
  /// Returns a list of instance booking maps or empty list on failure.
  static Future<List<Map<String, dynamic>>> getIntanceUserBookings(String userId) async {
  ...
  static Future<List<Map<String, dynamic>>> getUserBookings(String userId) async {
    final endpoint = 'api/user/my-bookings/$userId';
    final res = await FixMeHttpHelper.get(endpoint);
    if (res['success'] == true && res['data'] != null) {
      final data = res['data'];
      if (data is List) {
